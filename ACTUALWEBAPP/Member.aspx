...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main>   
        ...
        <div class="row">
            <section class="col-lg-4" aria-labelledby="solarIntensityTitle">
        ...
        <!-- Crime Data Service Section from project 3-->
            <section class="col-lg-4" aria-labelledby="crimeDataTitle">
        ...
        <!-- User Profile Section -->
            <section class="col-lg-4" aria-labelledby="userProfileTitle">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div>
                    ...
                    <br />
                    <asp:Label ID="CostLivingIndexLabel" runat="server" Text="Cost of Living Index: "></asp:Label>
                    <br />
                    <asp:Label ID="RentIndexLabel" runat="server" Text="Rent Index: "></asp:Label>
                    <br />
                    <asp:Label ID="CostLivingAndRentLabel" runat="server" Text="Cost of Living and Rent Index: "></asp:Label>
                    <br />
                    <asp:Label ID="GroceriesIndexLabel" runat="server" Text="Groceries Index: "></asp:Label>
                    <br />
                    <asp:Label ID="RestaurantPriceLabel" runat="server" Text="Restaurant Price Index: "></asp:Label>
                    <br />
                    <asp:Label ID="LocalPurchasingLabel" runat="server" Text="Local Purchasing Power Index: "></asp:Label>
                    <br />
                </div>     
            </div>
        </div>
